...
\newcommand{\sampleclean}{SampleCleanAgg\xspace}
...
we describe a line of work called SampleClean, which allows the analyst
...
data error and applies \sampleclean to approximate incremental view maintenance. ActiveClean extends the framework to a class of analytics
that we call convex data analysis (subsuming common aggregate queries
and including Machine Learning). 
\end{abstract}
