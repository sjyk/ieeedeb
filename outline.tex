...
we describe a project called SampleClean, which allows the analyst
to clean a sample of data and estimates query results based on the sample--linking Data Cleaning to Approximate Query Processing (AQP). 
We first proposed a technique to return bounded estimates of SUM, COUNT, and AVG 
queries using a sample of cleaned data. 
We subsequently applied this technique to model out-of-date data as a type of data error
leading to sample-based materialized views maintenance algorithms.
Finally, we explore analagous ideas in the context of Machine Learning in a project called ActiveClean. 
\end{abstract}
